package com.ram.spring.ai.project.dao;
...
import com.ram.spring.ai.project.repository.UsersRepositoryService;
...
public class UsersRepositoryImpl implements UsersRepositoryService {
	...
	@Override
	public boolean existsByemailIdIgnoreCaseAndIdNot(String emailId, long id) {
		return usersRepositoryService.existsByemailIdIgnoreCaseAndIdNot(emailId, id);
	}
